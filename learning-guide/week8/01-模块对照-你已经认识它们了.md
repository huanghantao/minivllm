...
```bash
ls $VLLM_SRC/vllm/v1/core/sched/scheduler.py \
   $VLLM_SRC/vllm/v1/request.py \
   $VLLM_SRC/vllm/v1/core/block_pool.py \
   $VLLM_SRC/vllm/model_executor/models/qwen3.py
```
...
```bash
grep -n "class RequestStatus" $VLLM_SRC/vllm/v1/request.py
grep -n "def schedule" $VLLM_SRC/vllm/v1/core/sched/scheduler.py
grep -n "def get_new_blocks" $VLLM_SRC/vllm/v1/core/block_pool.py
grep -n "class Qwen3Attention" $VLLM_SRC/vllm/model_executor/models/qwen3.py
```
