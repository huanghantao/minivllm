...
def generate_naive(model, input_ids, max_new_tokens, eos_token_id=None):
    ...
    """
    raise NotImplementedError("TODO: 看 learning-guide 对应章节，把这个函数填出来")  # generate_naive
...
def generate_with_cache(model, input_ids, max_new_tokens, eos_token_id=None):
    ...
    raise NotImplementedError("TODO: 看 learning-guide 对应章节，把这个函数填出来")  # generate_with_cache
