...
class BlockTable:
    ...
    def append_slot(self):
        ...
        """
        raise NotImplementedError("TODO: 看 learning-guide 对应章节，把这个函数填出来")  # BlockTable.append_slot

    def physical_slots(self):
        """返回全部 token 的物理槽位，按逻辑顺序（一个 list[int]）。"""
        raise NotImplementedError("TODO: 看 learning-guide 对应章节，把这个函数填出来")  # BlockTable.physical_slots
