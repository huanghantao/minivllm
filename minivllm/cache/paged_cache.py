...
class PagedKVCache:
    ...
    def write(self, layer_idx, slot_mapping, k, v):
        ...
        """
        raise NotImplementedError("TODO: 看 learning-guide 对应章节，把这个函数填出来")  # PagedKVCache.write
    ...
    def gather(self, layer_idx, slots):
        ...
        """
        raise NotImplementedError("TODO: 看 learning-guide 对应章节，把这个函数填出来")  # PagedKVCache.gather
