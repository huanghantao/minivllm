...
class NaiveKVCache:
    ...
    def append_and_get(self, layer_idx, k, v):
        ...
        """
        raise NotImplementedError("TODO: 看 learning-guide 对应章节，把这个函数填出来")  # NaiveKVCache.append_and_get
...
def kv_cache_memory_bytes(num_layers, num_heads, head_dim, seq_len, dtype_bytes=2):
    ...
    """
    raise NotImplementedError("TODO: 看 learning-guide 对应章节，把这个函数填出来")  # kv_cache_memory_bytes
